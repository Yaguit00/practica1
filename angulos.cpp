...
int main() {
    const int ANCHO = 9;
    cout << setw(ANCHO) << right << "Grados" 
    << setw(ANCHO) << "Radianes" 
    << setw(ANCHO) << right << "Seno" 
    << setw(ANCHO) << right << "Coseno" 
    << endl;
    ...
    for (double grados = 0; grados <= 180; grados += 10) {
        ...
        cout << setprecision(0) << setw(ANCHO) << right <<  grados 
             << setprecision(4) << setw(ANCHO) << right <<  radianes 
             << setw(ANCHO) << right << sin(radianes)
             << setw(ANCHO) << right << cos(radianes)
             << endl;
